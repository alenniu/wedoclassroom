...
const TeachersSection = ({sessions=[], total_sessions=0, teachers=[], total_teachers=0, is_admin, is_teacher, get_teachers, get_sessions, set_loading}) => {
...
export default connect(map_state_to_props, {get_teachers, get_sessions, set_loading})(TeachersSection);