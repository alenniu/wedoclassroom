    ...
    switch(type){
        ...
        case ADD_NEW_CLASS_RESCHEDULE:
            if(Array.isArray(new_state.edit.reschedules)){
                new_state.edit = {...new_state.edit, reschedules: [payload.reschedule, ...new_state.edit.reschedules]}
            }
        break;
