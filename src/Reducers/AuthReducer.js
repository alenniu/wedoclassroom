...
const INITIAL_STATE = {logged_in: false, is_admin: false, is_teacher: false, is_student: false, email: "", name: {first: "", last: ""}, phone: "", type: "customer", role: "", has_password: false, is_sso: false, error: "", bbr_data: {}, email_changed: false};
...
export default (state=INITIAL_STATE, action) => {
    ...
    switch(type){
        ...
        case LOGIN:{
            const {is_admin=false, is_teacher=false, is_student=false} = payload;
        ...
        case CHECK_LOGIN:{
            const {logged_in, is_admin=false, is_teacher=false, is_student=false} = payload;
