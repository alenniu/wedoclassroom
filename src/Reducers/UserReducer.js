...
export default (state=INITIAL_STATE, action) => {
    ...
    switch(type){
        ...
        case UPDATE_CLASS_REQUEST:{
            ...
            new_state.requests = new_state.requests.map((r) => r._id === request._id?request:r);
        }
        break;

        case ADD_NEW_CLASS_JOIN_REQUEST:
            new_state.requests = [...new_state.requests, payload.request];
            new_state.current_class_requests = [...new_state.current_class_requests, payload.request];
        break;
